...
const BookingSeer2 = () => {
  ...
  const handlePayment = async () => {
    ...
    const formattedDate = `${startTime.getFullYear()}-${String(startTime.getMonth()+1).padStart(2, '0')}-${String(startTime.getDate()).padStart(2, '0')}T${hour.padStart(2,'0')}:${minute.padStart(2,'0')}:00+07:00`;
    ...
    .then((res)=>{
      ...
      navigate("/bookingSeer4", { state: {bookingData: res, user_fullname: userInfo.first_name+" "+userInfo.last_name }});
    })
    .catch(()=>{
      alert()
    });
