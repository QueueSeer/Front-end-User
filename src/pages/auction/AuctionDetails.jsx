        ...
        <div className="mt-8 flex gap-8 items-start">
          ...
          <div className="flex-[1.4] bg-[#7B5EA7] text-white p-8 rounded-lg shadow-md text-left">
            ...
            <div className="text-center mt-8">
              <p className="text-xl font-bold">ประมูลดูดวงออนไลน์</p>
    ...
    <p>{auctionData.user.connectionType}</p>
        ...
        <div className="mt-12 text-left">
          ...
          <div className="flex gap-6 bg-white  p-6 pl-2 ">
            <img src={Images.tarotImages} alt="Tarot Reading" className="w-2/3 rounded-lg shadow" />
      ...
      {/* ปุ่มย้อนกลับ */}
            ...
            <button
                onClick={() => navigate("/homepage")} // ✅ ใช้ string "/homepage" ถูกต้อง
