...
<div className="relative w-screen block -mb-px">
  ...
  <div className="absolute right-4 md:right-12 lg:right-56 top-1/2 -translate-y-1/2 text-white max-w-md hidden xl:block">
    ...
    <button className="px-6 py-3 border border-white text-white font-bold text-lg rounded-full shadow-lg hover:bg-white hover:text-[#420F75] transition">
      เริ่มต้นการจองคิว
    </button>  
  </div>

  {/* ✅ ปุ่มใน iPad และมือถือ (ขยายขนาด และซ่อนข้อความใน iPad Pro) */}
  <div className="absolute right-4 md:right-20 top-1/2 -translate-y-1/2 xl:hidden">
    <button className="px-6 py-3 md:px-10 md:py-5 border border-white text-white font-bold text-lg md:text-2xl rounded-full shadow-lg hover:bg-white hover:text-[#420F75] transition">
      เริ่มต้นการจองคิว
    </button>  
  </div>
</div>
