        ...
        <div className="flex justify-between items-center mb-4">
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-gray-600 text-xl">{currentIndex + 1} of {totalPackages}</span>
                    <button onClick={onNext} disabled={currentIndex >= totalPackages - 4} className="p-2 rounded-full shadow-md">
