...
const IconSection = () => {
    ...
    return (
      <div className="relative p-4 overflow-x-auto sm:overflow-visible whitespace-nowrap scrollbar-hide">
        <div className="grid grid-cols-3 sm:grid-cols-7 gap-1 text-center flex-nowrap sm:flex-none">
