...
const CategoryCard = ({ category }) => {
    ...
    return (
        <div className="relative w-full h-52 rounded-lg overflow-hidden shadow-md">
            {/* รูปพื้นหลัง */}
            ...
            {isLastCard && <div className="absolute inset-0 bg-black opacity-50 flex items-center justify-center">
